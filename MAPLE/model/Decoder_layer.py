...
class TransformerDecoderLayer(nn.Module):
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(
        ...
        super().__init__()
        self.embed_dim = getattr(args, 'decoder_embed_dim', 256)
        self.dropout_module = nn.Dropout(p=0.5)
        self.no_encoder_attn=no_encoder_attn
        self.quant_noise = getattr(args, "quant_noise_pq", 0)
        self.quant_noise_block_size = getattr(args, "quant_noise_pq_block_size", 8)
        self.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 1024)
        ...
        self.normalize_before = args.decoder_normalize_before  # usually equal False
